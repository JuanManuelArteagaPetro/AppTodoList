...
class TodoAdapter(
    ...
    override fun onBindViewHolder(holder: TodoViewHolder, position: Int) {
        ...
        holder.itemView.apply {
            taskTitle.text = curTodo.title
            chexkBx.isChecked = curTodo.isChecked
            toggleStrikeThrough(taskTitle, curTodo.isChecked)
            chexkBx.setOnCheckedChangeListener { _, isChecked ->
                toggleStrikeThrough(taskTitle, isChecked)
